...
export function ProductCard({ product, onAdd }: ProductCardProps) {
  ...
  return (
    <motion.div
      ...
      style={{
        background:
          'linear-gradient(145deg, rgba(30, 20, 40, 0.9), rgba(15, 10, 25, 0.95))',
      ...
      whileHover={{
        scale: 1.02,
        boxShadow:
          '0 20px 50px rgba(0,0,0,0.5), 0 0 40px rgba(255, 45, 138, 0.15)',
      }}
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            'linear-gradient(135deg, rgba(255, 45, 138, 0.4), rgba(139, 61, 255, 0.4))',
          opacity: hovered ? 1 : 0,
          transition: 'opacity 0.4s',
        }}
      />
      <div
        className="relative rounded-2xl overflow-hidden m-[1px]"
        style={{
          background:
            'linear-gradient(145deg, rgba(30, 20, 40, 0.98), rgba(15, 10, 25, 1))',
        }}
      >
        {/* Image */}
        <div className="relative aspect-[3/4] overflow-hidden bg-black/50">
          ...
          <div
            ...
            style={{
              background:
                'linear-gradient(180deg, transparent 30%, rgba(15, 10, 25, 0.95) 100%)',
            }}
          />
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
            ...
            {discount > 0 && (
              <span
                ...
                style={{
                  background: 'linear-gradient(135deg, #ff3347, #ff2d8a)',
                  boxShadow: '0 0 15px rgba(255, 51, 71, 0.4)',
                }}
              >
                -{discount}%
              </span>
        ...
        <div className="p-4 space-y-2">
          ...
          {product.specs && (
            <p className="text-[11px] text-gray-500">
              {product.specs.height}cm • {product.specs.weight}kg •{' '}
          ...
          <div className="flex items-center justify-between pt-2">
            ...
            <motion.button
              ...
              whileHover={{
                scale: 1.1,
                boxShadow: '0 0 30px rgba(255, 45, 138, 0.6)',
              }}
              whileTap={{ scale: 0.9 }}
              onClick={handleAdd}
            >
